!(function () {
    ...
    if (
      ...
      for (let n = 0; n < t.length; n++)
        -1 !== s
          ...
          : (s = n);
      return (
        -1 !== s && a.push(t.slice(s)),
        $.slice(0, $.length - r.length) + a.join('')
      );
    }
  }
  function n(e, $) {
  ...
  function c(e, $, _, r) {
    for (let t in e) {
      ...
      if ($[a])
        throw Error(
          `Dynamic import map rejected: Overrides entry "${a}" from ${$[a]} to ${e[a]}.`
        );
      let i = e[t];
  ...
  function f(e, $) {
    ...
    if (_) {
      let r = $[_];
      if (null === r) return;
      if (!(e.length > _.length) || '/' === r[r.length - 1])
        return r + e.slice(_.length);
      o(_, r, "should have a trailing '/'");
    }
  }
  function o(e, $, _) {
    console.warn(
      'Package target ' + _ + ", resolving target '" + $ + "' for " + e
    );
  }
  function u(e, $, _) {
  ...
  let U = E,
    q = E(_('export default u=>import(u)')).then(
      (e) => (e && (U = e.default), !!e),
      r
    ),
    M = !1,
      ...
      if (e)
        return (
          ...
          Promise.all([
            ...
            S &&
              U(_('import"data:text/css,{}"assert{type:"css"}')).then(
                () => (T = !0),
                r
              ),
            O &&
              U(_('import"data:text/json,{}"assert{type:"json"}')).then(
                () => (M = !0),
                r
              ),
            new Promise((e) => {
  ...
  function X(e, $) {
    ...
    for (;;) {
      ...
      if (t === $) break;
      92 === t
        ? ((_ += B.slice(r, J)), (_ += Y()), (r = J))
        : (8232 === t || 8233 === t || (ee(t) && e$()), ++J);
    }
  ...
  function e$() {
    throw Object.assign(
      Error(
        `Parse error ${G}:${B.slice(0, J).split('\n').length}:${
          J - B.lastIndexOf('\n', J - 1)
        }`
      ),
      { idx: J }
  ...
  async function es(e, $) {
    e.b ||
      ...
      (($[e.u] = 1),
      await e.L,
      await Promise.all(e.d.map((e) => es(e, $))),
    ...
    ef = P.then(() => {
      if (!k) {
        ...
        for (let $ of document.querySelectorAll(
          ...
          if (
            (e || 'module' !== $.type || (e = !0), $.type.endsWith('-shim'))
          ) {
            j();
            break;
          }
          ...
          for (let $ of e)
            if ('childList' === $.type)
              for (let _ of $.addedNodes)
                'SCRIPT' === _.tagName
                  ? (((!k && 'module' === _.type) ||
                      (k && 'module-shim' === _.type)) &&
                      e8(_),
                    ((!k && 'importmap' === _.type) ||
                      (k && 'importmap-shim' === _.type)) &&
                      eO(_))
  ...
  async function e0($, r, t, a, i) {
    if ((k || (eu = !1), await eo, !k && el))
      return a ? null : (await i, U(t ? _(t) : $, { errUrl: $ || t }));
                    ...
                    F = (D = (function (e, $, _) {
                      ...
                      function m(e) {
                        ...
                        switch (t[e >> 1] | 0) {
                          ...
                          case 121:
                            e =
                              S((e + -2) | 0, 102, 105, 110, 97, 108, 108) | 0;
                            break;
                          case 101:
                      ...
                      function er() {
                        return (
                          (((a[((a[6] | 0) + 4) >> 2] | 0) - (a[3] | 0)) >> 1) |
                          0
                        );
                      }
                      function et() {
                        return (
                          (((a[((a[7] | 0) + 4) >> 2] | 0) - (a[3] | 0)) >> 1) |
                          0
                        );
                      }
                      function ea() {
                  ...
                  t.a[0].map(async ({ n: _, d: r }) => {
                    ...
                    if ((i && (!H || ec) && (t.n = !0), -1 === r))
                      return (a || eE(_, t.r || t.u), p && p.test(a))
                        ? { b: a }
                        : ($.integrity &&
                            ($ = Object.assign({}, $, { integrity: void 0 })),
                          e(a, $).f);
                  })
                )
              ).filter((e) => e);
        ...
        if (i.length) {
          ...
          for (let { s: f, se: o, d: u } of i)
            if (-1 === u) {
              ...
              if (d) {
                if (b.s) {
                  (n += `${s.slice(c, f - 1)}/*${s.slice(f - 1, o)}*/${ek(
                    d
                  )};import*as m$_${l} from'${
                    b.b
                ...
                (d = b.s) ||
                  (d = b.s =
                    _(`export function u$_(m){${b.a[1]
                      ...
                      .join(';')}
//# sourceURL=${b.r}?cycle`));
              (n += `${s.slice(c, f - 1)}/*${s.slice(f - 1, o)}*/${ek(d)}`),
                (c = o);
            } else
              -2 === u
                ? ((eb[r.r] = { url: r.r, resolve: ed }),
                  (n += `${s.slice(c, f)}self._esmsm[${ek(r.r)}]`),
                  (c = o))
                : ((n += `${s.slice(c, u + 6)}Shim(${s.slice(f, o)}, ${
                    r.r && ek(r.r)
                  }`),
                  (c = o));
          n += s.slice(c);
        ...
        (n = n.replace(
          ep,
          (e, $, _) => ((k = !$), e.replace(_, () => new URL(_, r.r)))
        )),
          k || (n += '\n//# sourceURL=' + r.r),
          (r.b = eh = _(n)),
          (r.S = void 0);
  ...
  (self.importShim = e6),
    k && (e6.getImportMap = () => JSON.parse(JSON.stringify(en)));
  let eb = {};
  ...
  async function e5(e, $) {
    ...
    if (e7.test(t))
      return { r: r.url, s: `export default ${await r.text()}`, t: 'json' };
    if (e1.test(t))
      return {
        r: r.url,
  ...
  function ev() {
    for (let e of document.querySelectorAll(
      k ? 'script[type="module-shim"]' : 'script[type="module"]'
    ))
      e8(e);
  ...
  function eg() {
    for (let e of document.querySelectorAll(
      k ? 'script[type="importmap-shim"]' : 'script[type="importmap"]'
    ))
      eO(e);
  }
  function e9(e) {
        ...
        ((eo = eo
          .then(async () => {
            en = (function e($, _, r) {
              ...
              e.src ? await (await A(e.src)).json() : JSON.parse(e.innerHTML),
              e.src || $,
              en
            );
          })
  ...
  function e8(e) {
    if (e.ep || null !== e.getAttribute('noshim') || (!e.src && !e.innerHTML))
      return;
    e.ep = !0;
    let _ = eL > 0,
      r = eA > 0;
  ...
  function eE(e, $) {
    throw Error(
      "Unable to resolve specifier '" + e + ($ ? "' from " + $ : "'")
    );
  }
})();
